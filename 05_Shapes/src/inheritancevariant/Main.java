...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Shape> shapes3 = new ArrayList<>(); //dynamicke pole objektů typu Shape
        //muze obsahovat cokoli, co je typove kompatibilni s Shape (Shape, Circle, Rectangle)
        //Shape s = new Rectangle(5, 6);
        //Rectangle r = new Shape(); //nejde predka vlozit do potomka, pokud je Shape abstract nelze vytvorit ani instanci
        shapes3.add(c1);
        shapes3.add(r1);
